...
def test_seo_features():
    ...
    with app.app_context():
        with app.test_request_context('/'):
            ...
            images_to_check = ['myself.jpg', 'myself-social.jpg', 'favicon.ico', 'favicon.png']
            ...
            print("2. Facebook Sharing Debugger: https://developers.facebook.com/tools/debug/")
            print("3. Twitter Card Validator: https://cards-dev.twitter.com/validator")
            print("4. LinkedIn Post Inspector: https://www.linkedin.com/post-inspector/")
